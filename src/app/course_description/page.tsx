            ...
            <div className="text-white text-center lg:text-left">
             ...
             <div className="flex justify-center lg:justify-end items-center">
               <div className="relative">
                 {/* Vector Images in Circular Layout */}
                 <div className="w-64 h-64 relative">
                   ...
                   {/* Vector4.png at center */}
                   <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                     <Image
                       src="/assets/icons/Vector4.png"
                       alt="Vector4"
                       width={48}
                       height={48}
                       className="object-contain"
            ...
            {/* Right Column - Course Details Card */}
             <div className="lg:col-span-1">
               <div className="bg-white rounded-lg shadow-lg border border-gray-200">
                {/* Top Section with Lecture Image */}
                <div className="w-full">
                  <Image
                    src="/assets/images/lecture-1.png"
                    alt="Lecture 1"
                    width={409}
                    height={192}
                   ...
                   <div className="flex items-center justify-between">
                     <div className="flex items-center">
                       <Image
                         ...
                         className="object-contain"
                       />
                       <span className="ml-2 text-gray-900 font-semibold">4.90</span>
                     </div>
                      ...
                      <div className="flex items-center">
                        <Image
                          ...
                          className="object-contain"
                        />
                        <span className="ml-2 text-gray-600">Enrolled: 202,451</span>
                      </div>
                      <div className="w-0.5 h-6 bg-gray-300"></div>
                     <div className="flex items-center">
                       <Image
                ...
                <div className="bg-gray-100 p-4 border-b border-gray-200">
                  <h4 className="text-sm font-semibold text-gray-500 uppercase text-center">KEY FEATURES OF THIS COURSE</h4>
                </div>
                ...
                <div className="p-6">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      />
                      <span className="text-gray-700">Key Features Of This Course</span>
                    </div>
                    <div className="flex items-center">
                      <Image
                    ...
                    <div className="flex items-center">
                      <Image
                        ...
                        className="object-contain mr-3"
                      />
                      <span className="text-gray-700">Unlimited Access Forever</span>
                    </div>
                    <div className="flex items-center">
                      <Image
                  ...
                  {/* Add to Cart Button */}
                  <button className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-lg transition-colors mt-6">
                    Add to Cart
                  </button>
                </div>
              </div>
